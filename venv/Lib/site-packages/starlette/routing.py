...
class Mount(BaseRoute):
    def __init__(
        ...
        *,
        ...
        assert app is not None or routes is not None, "Either 'app=...', or 'routers=' must be specified"
    ...
    def routes(self) -> list[BaseRoute]:
        return getattr(self._base_app, "routers", [])
...
class Host(BaseRoute):
    ...
    @property
    def routes(self) -> list[BaseRoute]:
        return getattr(self.app, "routers", [])
...
class Router:
    ...
    def route(
        ...
        >>> routers = [Route(path, endpoint=...), ...]
        >>> app = Starlette(routers=routers)
        """
        warnings.warn(
    ...
    def websocket_route(self, path: str, name: str | None = None) -> typing.Callable:  # type: ignore[type-arg]
        ...
        >>> routers = [WebSocketRoute(path, endpoint=...), ...]
        >>> app = Starlette(routers=routers)
        """
        warnings.warn(
