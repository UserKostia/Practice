...
class TableClause(roles.DMLTableRole, Immutable, NamedFromClause):
    ...
    the usual set of :class:`_expression.FromClause` db including
    the ``.c.`` collection and statement generation methods.

    It does **not** provide all the additional schema-level db
    of :class:`_schema.Table`, including constraints, references to other
    tables, or support for :class:`_schema.MetaData`-level db.
    It's useful
